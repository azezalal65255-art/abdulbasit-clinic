...
function getDefaultDatabase(): DatabaseSchema {
  ...
  const defaultConditions: MedicalConditionItem[] = [
    {
      id: 'cond_gerd',
      name: 'ارتجاع المريء',
      slug: 'gerd',
      category: 'digestive',
      icon: 'Flame',
      description: 'رجوع حمض المعدة إلى المريء مسببًا شعورًا بالحرقة وحموضة في الحلق والصدر.',
      ...
      treatmentApproach: 'تحديد السبب ودرجة الارتجاع، تنظيم العادات الغذائية، ووصف خطة دوائية علاجية واقية لبطانة المريء مع متابعة دقيقة.',
      isActive: true,
      order: 1,
      createdAt: '2026-01-01T00:00:00.000Z',
      updatedAt: '2026-01-01T00:00:00.000Z',
    },
    {
      ...
      category: 'digestive',
      icon: 'Bug',
      description: 'بكتيريا حلزونية تستوطن بطانة المعدة وتسبب التهابات مزمنة وقد تؤدي للقرحة.',
      symptoms: ['ألم حارق في أعلى البطن', 'انتفاخ وتجشؤ مستمر', 'فقدان الشهية وغثيان متكرر', 'شعور سريع بالامتلاء عند الأكل'],
      treatmentApproach: 'تشخيص دقيق عبر الفحوصات المعتمدة، ثم وصف البروتوكول العلاجي الرباعي أو الثلاثي المنضبط مع اختبار التأكد من القضاء عليها.',
      isActive: true,
      order: 2,
      createdAt: '2026-01-01T00:00:00.000Z',
      updatedAt: '2026-01-01T00:00:00.000Z',
    },
    {
      ...
      category: 'digestive',
      icon: 'ShieldAlert',
      description: 'تآكل في الغشاء المخاطي المبطن للمعدة أو الاثني عشر يحتاج تشخيصًا وعلاجًا دقيقًا.',
    ...
    },
    {
      ...
      category: 'digestive',
      icon: 'RefreshCw',
      description: 'اضطراب وظيفي شائع في حركة الأمعاء يتأثر بالحمية والتوتر والعوامل العصبية.',
    ...
    },
    {
      ...
      category: 'liver',
      icon: 'Layers',
      description: 'تراكم غير طبيعي للدهون داخل خلايا الكبد يتطلب متابعة مبكرة لمنع تطور الالتهاب.',
      symptoms: ['غالبًا بدون أعراض واضحة في مراحله الأولى', 'إرهاق وخمول عام', 'ثقل خفيف في الجانب الأيمن العلوي من البطن'],
      treatmentApproach: 'تقييم شامل لدرجة ترسب الدهون ووظائف الكبد، وضع خطة لتنظيم الوزن والدهنيات وعلاج الأسباب مع المتابعة الدورية.',
      isActive: true,
      order: 5,
      createdAt: '2026-01-01T00:00:00.000Z',
      updatedAt: '2026-01-01T00:00:00.000Z',
    ...
    {
      id: 'cond_enzymes',
      name: 'ارتفاع إنزيمات الكبد',
      slug: 'liver-enzymes',
      category: 'liver',
      icon: 'TrendingUp',
      description: 'مؤشر مخبري يعكس وجود نشاط أو التهاب أو إجهاد في خلايا الكبد يحتاج كشف سببه.',
      symptoms: ['يكتشف غالبًا في الفحص الدوري', 'تعب عام', 'غثيان خفيف أو تغير في لون البول أحيانًا'],
      treatmentApproach: 'إجراء مسح تشخيصي موسع للكشف عن السبب الكامن (أدوية، فيروسات، دهون، مناعة) ووضع خطة موجهة فورية.',
      isActive: true,
      order: 6,
      createdAt: '2026-01-01T00:00:00.000Z',
      updatedAt: '2026-01-01T00:00:00.000Z',
    },
    {
      ...
      category: 'liver',
      icon: 'Activity',
      description: 'التهاب في نسيج الكبد ناجم عن أسباب فيروسية أو مناعية أو دوائية مختلفة.',
      symptoms: ['إرهاق عام شديد', 'يرقان (اصفرار بياض العينين والجلد)', 'بول داكن وبراز فاتح', 'آلام في المفاصل وفقدان الشهية'],
      treatmentApproach: 'تحديد نوع الفيروس أو السبب المناعي بدقة، وعمل الفحوصات الجينية والمخبرية للبدء في العلاج الموجه ومراقبة الحمل الفيروسي.',
      isActive: true,
      order: 7,
      createdAt: '2026-01-01T00:00:00.000Z',
      updatedAt: '2026-01-01T00:00:00.000Z',
    ...
    {
      id: 'cond_gas',
      name: 'الانتفاخ والغازات',
      slug: 'bloating-gas',
      category: 'digestive',
      icon: 'Wind',
      description: 'تجمع غير مريح للغازات في الجهاز الهضمي ناتج عن اضطرابات الهضم أو بكتيريا الأمعاء.',
      symptoms: ['بروز وانتفاخ في البطن', 'شعور بالضغط والامتلاء الشديد', 'تجشؤ متكرر وأصوات معوية'],
      treatmentApproach: 'كشف مسببات سوء الهضم أو عدم تحمل أطعمة معينة أو فرط النمو البكتيري، وإعادة التوازن الميكروبي المعوي.',
      isActive: true,
      order: 8,
      createdAt: '2026-01-01T00:00:00.000Z',
      updatedAt: '2026-01-01T00:00:00.000Z',
    ...
    {
      id: 'cond_constipation',
      name: 'الإمساك المزمن',
      slug: 'chronic-constipation',
      category: 'digestive',
      icon: 'Clock',
      description: 'صعوبة أو قلة في حركة الأمعاء والإخراج تستمر لفترات طويلة وتؤثر على راحة المريض.',
      symptoms: ['إخراج أقل من ثلاث مرات أسبوعيًا', 'صعوبة وألم أثناء التبرز', 'شعور بعدم الإفراغ الكامل وثقل بالبطن'],
      treatmentApproach: 'فحص مسببات كسل الأمعاء واستبعاد الانسدادات العضوية، تعديل الألياف والسوائل، وخطة دوائية آمنة غير إدمانية.',
      isActive: true,
      order: 9,
      createdAt: '2026-01-01T00:00:00.000Z',
      updatedAt: '2026-01-01T00:00:00.000Z',
    ...
    {
      id: 'cond_diarrhea',
      name: 'الإسهال المتكرر',
      slug: 'recurrent-diarrhea',
      category: 'digestive',
      icon: 'AlertTriangle',
      description: 'تكرار البراز الرخو أو المائي لفترات متباعدة أو مستمرة يتطلب تشخيصًا دقيقًا.',
      symptoms: ['براز رخو متكرر يوميًا', 'تقلصات ومغص بطني مرافق', 'جفاف أو فقدان سريع للسوائل'],
      treatmentApproach: 'استقصاء العدوى المعوية، التهابات القولون المناعية، أو حساسية القمح والغذاء، ووصف العلاج المنظم لحركة الأمعاء.',
      isActive: true,
      order: 10,
      createdAt: '2026-01-01T00:00:00.000Z',
      updatedAt: '2026-01-01T00:00:00.000Z',
    },
    {
      ...
      category: 'digestive',
      icon: 'CheckCircle2',
      description: 'إحساس بتوقف الطعام أو السوائل في المريء أثناء البلع يحتاج تقييمًا طبيًا عاجلًا.',
      symptoms: ['شعور بالتصاق الطعام في الحلق أو الصدر', 'ألم أثناء البلع', 'سعال أثناء تناول الطعام أو المشروبات'],
      treatmentApproach: 'إجراء تقييم سريري وتنظيري دقيق لفحص بطانة المريء وقطره، وتحديد الإجراء المناسب سواء دوائيًا أو توسيعًا.',
      isActive: true,
      order: 11,
      createdAt: '2026-01-01T00:00:00.000Z',
      updatedAt: '2026-01-01T00:00:00.000Z',
    ...
    {
      id: 'cond_abdominal_pain',
      name: 'آلام البطن',
      slug: 'abdominal-pain',
      category: 'general',
      icon: 'Stethoscope',
      description: 'ألم موضعي أو منتشر في البطن قد ينتج عن اضطرابات المعدة أو الأمعاء أو الكبد والصفراء.',
      symptoms: ['مغص حاد أو ألم متواصل كليل', 'ألم يرتبط بالوجبات أو يأتي فجأة', 'مصحوب بغثيان أو تغير في الهضم'],
      treatmentApproach: 'فحص سريري تشخيصي دقيق، تصوير تليفزيوني وفحوصات مخبرية ومنظارية لتحديد المصدر وعلاجه من جذوره.',
      isActive: true,
      order: 12,
      createdAt: '2026-01-01T00:00:00.000Z',
      updatedAt: '2026-01-01T00:00:00.000Z',
  ...
  const defaultEndoscopy: EndoscopyItem[] = [
    {
      id: 'endo_gastro',
      title: 'منظار المعدة',
      slug: 'gastroscopy',
      ...
      preInstructions: [
        'الصيام التام عن الطعام والماء لمدة 6 إلى 8 ساعات قبل الموعد',
        'إبلاغ الطبيب بجميع الأدوية المتناولة خاصة مميعات الدم',
        'الحضور مع مرافق لقيادة السيارة بعد الإجراء',
      ],
      postInstructions: [
        'الانتظار لمدة نصف ساعة قبل شرب الماء حتى يزول أثر مخدر الحلق',
        'تناول وجبات خفيفة معتدلة الحرارة في اليوم الأول',
        'تجنب قيادة السيارة أو الأعمال الشاقة لبقية اليوم',
      ],
      isActive: true,
      order: 1,
      createdAt: '2026-01-01T00:00:00.000Z',
    ...
    },
    {
      ...
      preInstructions: [
        'شرب كميات وفيرة من السوائل الصافية قبل الإجراء بيوم',
        'تناول المحلول المنظف للقولون بدقة وفق الجدول المكتوب المستلم من العيادة',
        'تجنب الأطعمة الصلبة والبذور قبل الموعد بـ 24 ساعة',
      ],
      postInstructions: [
        'الراحة في المنزل لعدة ساعات بعد الإجراء',
        'الشعور ببعض الغازات أمر طبيعي يزول سريعاً بالحركة والمشي',
        'استئناف التغذية الطبيعية تدريجياً حسب إرشادات الطبيب',
      ],
      isActive: true,
      order: 2,
      createdAt: '2026-01-01T00:00:00.000Z',
    ...
    },
    {
      ...
      duration: 'يتم أثناء إجراء المنظار دون ألم إضافي',
      prepSummary: 'إجراء روتيني وسلس تمامًا يتم من خلال ملقط منظاري دقيق وخاص دون أي شعور بالألم من المريض.',
      preInstructions: ['تجهيز التاريخ الدوائي الدقيق خصوصاً أدوية السيولة'],
      postInstructions: ['الالتزام بتعليمات الطبيب لحين صدور التقرير الباثولوجي خلال 3-5 أيام'],
      isActive: true,
      order: 3,
      createdAt: '2026-01-01T00:00:00.000Z',
      updatedAt: '2026-01-01T00:00:00.000Z',
    },
    {
      ...
      preInstructions: ['الاتصال بالعيادة عند وجود أي استفسار بشأن التحضير'],
      postInstructions: ['الالتزام الكامل بالتعليمات الطبية المكتوبة'],
      isActive: true,
      order: 4,
      createdAt: '2026-01-01T00:00:00.000Z',
      updatedAt: '2026-01-01T00:00:00.000Z',
